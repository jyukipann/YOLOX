...
if __name__ == "__main__":
    ...
    # target_result_csv_path = r"experiment_result\finetuned\flir_dataset_val_thermal_yolox_result_finetuned.csv"
    ...
    # target_color = (20, 255, 181,)
    # target_color = (20, 255, 245,)
    window_titles = []
    ...
    for img_id in img_ids:
        ...
        if target_not_none:
            ...
            for target_id_rect in target_id_rects[target_index]:
                ...
                # cv2.rectangle(target_rect_mask,(x1,y1),(x2,y2),(1,),3)
        ...
        if isImgShow:
            ...
            # cv2.imwrite(f"finetuned755.png",img)
            cv2.imwrite(f"before755.png",img)
            if iou_min == 0:
                pass
