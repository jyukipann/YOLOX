...
if __name__ == '__main__':
    ...
    data = opencsv(r'experiment_result\before\20220607_flir_dataset_val_RGB_yolox_result_sunny.csv')
    ...
    out_path = r'experiment_result\before\20220607_flir_dataset_val_RGB_yolox_iou_result_sunny.csv'
