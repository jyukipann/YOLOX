...
RGB_image_points = np.array(RGB_image_points)
...
Thermal_img_points = np.array(Thermal_img_points)
...
# retval, H1, H2 = cv2.stereoRectifyUncalibrated(RGB_image_points, Thermal_img_points,)
